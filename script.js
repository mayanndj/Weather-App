...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'C:\Users\lenov\Desktop\FullStackExam\clouds.jpg';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'C:\Users\lenov\Desktop\FullStackExam\rainy.jpg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'C:\Users\lenov\Desktop\FullStackExam\clear.jpg';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'C:\Users\lenov\Desktop\FullStackExam\snow.jpg';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'C:\Users\lenov\Desktop\FullStackExam\sunny.jpg';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'C:\Users\lenov\Desktop\FullStackExam\thunderstrom.jpg';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'C:\Users\lenov\Desktop\FullStackExam\drizzle.jpg';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'C:\Users\lenov\Desktop\FullStackExam\mist.jpg';
    } else {
        document.body.style.backgroundImage = 'C:\Users\lenov\Desktop\FullStackExam\bg.jpg';
    }
}
